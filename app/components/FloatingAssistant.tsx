  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        .floatingEcho.listening .floatingBall { animation:floatingListen .55s ease-in-out infinite alternate; }
        .floatingEcho.listening { box-shadow:0 0 35px rgba(70,210,255,.75),0 0 90px rgba(20,140,255,.35); }
        ...
        .floatingEyebrow { display:block; margin-bottom:4px; color:#63808d; font-size:8px; letter-spacing:2px; }
        .floatingAssistantPanel strong { color:#aee4f7; font-size:11px; letter-spacing:1px; }
        .floatingAssistantPanel p { margin-top:5px; color:#67808a; font-size:10px; line-height:1.4; }
        .floatingClose { width:26px; height:26px; border-radius:7px; background:#10171c; color:#8ca5af; font-size:18px; }
        @keyframes floatingBounce { 0%,100%{transform:translateY(3px)} 50%{transform:translateY(-5px)} }
        @keyframes floatingPulse { 0%,100%{opacity:.45;transform:scale(.92)} 50%{opacity:.9;transform:scale(1.08)} }
        @keyframes floatingListen { from{transform:scale(.96)} to{transform:scale(1.05)} }
        @keyframes floatingThink { from{transform:scale(.95) rotate(-2deg)} to{transform:scale(1.04) rotate(2deg)} }
        @keyframes floatingTalk { from{transform:translateX(-50%) scaleY(.65)} to{transform:translateX(-50%) scaleY(1.3)} }
