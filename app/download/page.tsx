  ...
  return (
    <main className="downloadPage">
      <nav className="downloadNav">
        <Link href="/download" className="brand">ECHO ASSISTANT</Link>
      ...
      <section className="hero">
        ...
        <p className="eyebrow">ECHO ASSISTANT • PERSONAL AI</p>
        <h1>Your assistant.<br /><span>Ready when you are.</span></h1>
        <p className="lead">ECHO Assistant is a personal AI workspace for conversations, chat history, voice commands, memory, and supported Google tools such as Gmail and Calendar. Use ECHO in your browser or install it as a web app.</p>
        <div className="actions"><Link href="/" className="primaryButton">GO TO ECHO</Link>{!installed && installEvent && <button type="button" className="secondaryButton" onClick={installECHO}>INSTALL ECHO</button>}</div>
        {installed && <p className="installedNote">✓ ECHO Assistant is installed on this device.</p>}
      ...
      <section id="features" className="features" aria-label="ECHO Assistant features">
        ...
        <article><span>02</span><h2>GOOGLE TOOLS</h2><p>With your permission, ECHO can work with supported Google services such as Gmail and Calendar.</p></article>
